...
Pyramid::Pyramid(GLFWwindow* passedWindow, GLfloat* verts,int sizeVerts) {
	this->Window = passedWindow;
	Pyramid::CreateMesh(gMesh, verts, sizeVerts);
}

void Pyramid::CreateMesh(GLMesh& mesh, GLfloat* verts, int sizeVerts)
{
	//########################################################################################################################################
	// Mesh starts here
	//########################################################################################################################################
	...
	GLushort indices[] = {
		...
		3, 4, 5, //Left triangle face 
		6, 7, 8, //Right triangle face 
		9, 10, 11, //Back triangle face 
		12, 13, 14, //Right-Base triangle face 
		15, 12, 14 //Left-Base triangle face 
	};
...
//delete mesh
void Pyramid::DestroyMesh(GLMesh& mesh)
{
